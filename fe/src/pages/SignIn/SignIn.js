    ...
    <React.Fragment>
      <Paper className={classes.paper} elevation={6}>
        <div style={{}} className={classes.container}>
          <Typography component="h1" variant="h5" className={classes.padding} style={{ color: '#3d3d5c'}}>
            {'Sign Out'}
          </Typography> 
          <Typography gutterBottom style={{ color: '#3d3d5c'}}>If you are not the only one on this device.</Typography>
          <Button style={{ background: '#3d3d5c' }} fullWidth variant="contained" margin="normal" color="secondary" onClick={handleSignOut} className={classes.buttonPadding}>
            {'Sign Out'}
          </Button>
          ...
          <Typography gutterBottom style={{ color: '#3d3d5c'}}>If this is your device.</Typography>
          <Button style={{ background: '#3d3d5c' }} fullWidth variant="contained" margin="normal" color="primary" onClick={handleFastSignIn} className={classes.buttonPadding}>
            {'Sign In'}
          </Button>

          <Typography component="h1" variant="h5" style={{ color: '#3d3d5c'}}>
            {'Password Sign In'}
          </Typography>
          <Typography gutterBottom style={{ color: '#3d3d5c'}}>You may password-sign-in on any device.</Typography>
